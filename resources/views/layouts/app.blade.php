        ...
        <div class="mx-auto md:mr-5 md:mx-0 w-70">
            ...
            <div 
                ...
                <form action="#" method="POST" class="px-4 py-6 space-y-4">
                    <div>
                        <input type="text" class="w-full px-4 py-2 text-sm bg-gray-100 border-none rounded-xl placeholder:text-gray-900" placeholder="Your idea" />
                    </div>
                    ...
                    <div>
                        <textarea name="idea" id="idea" cols="30" rows="4" class="w-full px-4 py-2 text-sm bg-gray-100 border-none rounded-xl placeholder:text-gray-900" placeholder="Describe your idea.">
                            </textarea>
                    </div>
